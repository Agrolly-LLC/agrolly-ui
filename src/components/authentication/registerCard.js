...
export default class RegisterCard extends Component {
  ...
  getState() {
    ...
    if (this.state.usercountry === "Brazil") {
      axios
        .get("http://agrolly.tech/get_cities.php")
        .then((response) => {
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <div className="input-group mb-3">
                ...
                >
                  ...
                  {this.state.stateset.map((allstate, index) => {
                    return (
                      <option key={index} value={allstate}>
                        {allstate}
                      </option>
                    );
                  })}
              ...
              {/* <div className="input-group mb-3">
                <select
                  ...
                  <option disabled>Choose...</option>
                  {this.state.cities.map((allcity , index) => {
                    return <option key={index} value={allcity}>{allcity}</option>;
                  })}
                </select>
                <div className="input-group-append">
                  <label
              ...
              >
                <p>
                  1. I accept Agrolly’s Terms and Conditions <br />
                  2. All information on this app or on Agrolly’ s website site
                  is provided "as is", with no guarantee of completeness,
                  accuracy, timeliness or of the results obtained from the use
                  of this information. You assume full responsibility for your
                  use of the information, and understand and agree that Agrolly
                  is neither responsible, nor liable, to you in any manner
